...
const Sidebar = ({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen, adminData, onLogout, notificationData }) => {
  const menuItems = [
  ...
  // Get notification counts from props or return null
  const getNotificationCount = (tabId) => {
    if (!notificationData) return null;
    
    switch(tabId) {
      case 'course-verification':
        return notificationData.pendingCourseVerifications || null;
      case 'educator-verification':
        return notificationData.pendingEducatorVerifications || null;
      case 'financial':
        return notificationData.pendingTransactions || null;
      default:
        return null;
    }
  };
