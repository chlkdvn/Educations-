...
const Dashboard = () => {
  const { currency, isEducactor, backendUrl } = useContext(AppContext);
  ...
  // Default empty data structure if null
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${currency}${data.totalEarnings?.toLocaleString() || '0'}`,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden mb-6">
          ...
          <div className="divide-y divide-gray-100">
            {data.enrolledStudentsData?.slice(0, 5).map((item, index) => (
            ...
            {(!data.enrolledStudentsData || data.enrolledStudentsData.length === 0) && (
          ...
          {data.enrolledStudentsData?.length > 5 && (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-lg font-bold text-blue-900 mt-1">
                  {data.enrolledStudentsData?.filter(s => s.isActive).length || 0}
                </p>
              </div>
